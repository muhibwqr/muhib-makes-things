  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      useEffect(() => {
        ...
        // ...all your animation and WebGL logic here, unchanged...
        // (Omitted for brevity, keep your full code here)
        ...
        function addEvent<K extends keyof WindowEventMap>(
          ...
          eventRemovers.push(() => target.removeEventListener(type, handler));
        }

        // Replace all window.addEventListener(...) with addEvent(...)
        // For example:
        // addEvent(window, 'mousedown', ...)
        // addEvent(window, 'mousemove', ...)
        // addEvent(window, 'resize', ...)
        // ...and so on for all listeners

        // At the end of your useEffect, add cleanup:
        return () => {
